              ...
              {analyses.map((analysis) => {
                ...
                return (
                  <button
                    ...
                    className="w-full text-left bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-xl border border-transparent hover:border-blue-200 dark:hover:border-blue-800 p-6 transition-all duration-200 group"
                  >
